...
#ifdef MX64_1024
const int MX64::CENTER_VALUE = 512;
const int MX64::MAX_VALUE = 1023;
const double MX64::MIN_ANGLE = -150.0; // degree
const double MX64::MAX_ANGLE = 150.0; // degree
const double MX64::RATIO_VALUE2ANGLE = 0.293; // 300 / 1024
const double MX64::RATIO_ANGLE2VALUE = 3.413; // 1024 / 300
const int MX64::PARAM_BYTES = 5;
#else
